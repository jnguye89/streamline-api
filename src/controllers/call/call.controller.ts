...
} from 'src/dto/agora/agora-token.dto';
...
export class CallController {
  ...
  @Public()
  createAnonymousToken(@Body() dto: CreateViewerTokenDto) {
    return this.agoraTokenService.createViewerTokens(
      dto.channel,
      dto.ttlSeconds,
    );
  }
  ...
  async startPodcast(
    ...
    await this.agoraRecordingService.getResourceId(
      dto.channelName,
      user.userId,
    );
